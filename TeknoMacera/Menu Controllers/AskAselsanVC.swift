 ...
 */
class AskAselsanVC: UIViewController, SideMenuItemContent, Storyboardable,WKNavigationDelegate,WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.teknomacera.com/asele-soruyorum/")
